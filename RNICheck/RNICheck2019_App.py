...
# Load the input JSON
InputDetails = input_json_check(inputJSON, 2, req_keys=['file_name', 'balai', 'year', 'routes'])
...
OutputGDBTable = 'SMD.RNI_{0}_RERUN_2'.format(DataYear)  # The GDB table which store all the valid table row
