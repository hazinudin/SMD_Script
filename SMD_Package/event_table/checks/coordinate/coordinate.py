...
class InputPoint(object):
    ...
    def distance_to_df_segment(self, from_m, to_m, lane, rni_df, rni_from_m='STA_FROM', rni_to_m='STA_TO',
                               rni_lane_code='LANE_CODE', rni_lat='STATO_LAT', rni_long='STATO_LONG'):
        """
